...
const Howtoplay = () => {
  ...
  return (
<div className={`fixed bg-[#212226] z-20 md:h-[50%] h-[50%] md:w-[30%] w-[90%] md:top-9 bottom-30 md:left-[35%] left-[5%] rounded-xl  ${howtoplaySelector ? "" : "hidden"}`}>
          ...
          <div className='text-center text-white mx-5 mt-2'> Will the roll be red or black? Place your bet and spin, or if you’re feeling lucky, choose 'High risk mode' and HOT for a spicy x1056 multiplier!</div>
        </div>
  )
}
